...
def load_ghost_images():
    ghost_images = {}
    try:
        ghost_images['red'] = pygame.image.load(os.path.join('rojo.png')).convert_alpha()
        ghost_images['pink'] = pygame.image.load(os.path.join('rosa.png')).convert_alpha()
        ghost_images['orange'] = pygame.image.load(os.path.join('naranja.png')).convert_alpha()
